function UserData(){
    ...
    return (<>
      ...
      function UserDataMsg(props){
        ...
        <button type="submit" className="btn btn-danger" onClick={() => props.setShow(true)}>Hide Account Info</button>
      </>);
    }
    ...
    return (
      <>
      <button type="submit" className="btn btn-danger" onClick={handle}>View Account Info</button>
      </>
        )
      }
